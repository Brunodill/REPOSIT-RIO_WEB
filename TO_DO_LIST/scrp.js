...
function obterPrioridade() {
    ...
    // Se nenhum checkbox estiver selecionado retorna a cor branca
    return '#ccc';
    }
}
...
function adicionarTarefa() {
    ...
    //recebe a referência da lista onde as tarefas serão adicionadas
    ...
    if (texto) {
        ...
        //Cria um elemento de lista (li) para a nova tarefa
